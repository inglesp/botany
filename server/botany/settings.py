...
if BOTANY_TOURNAMENT_START_AT is None:
    ...
    if BOTANY_TOURNAMENT_START_AT.tzinfo is None:
        BOTANY_TOURNAMENT_START_AT = BOTANY_TOURNAMENT_START_AT.replace(
            tzinfo=timezone.utc
        )
...
if BOTANY_TOURNAMENT_CLOSE_AT is None:
    ...
    if BOTANY_TOURNAMENT_CLOSE_AT.tzinfo is None:
        BOTANY_TOURNAMENT_CLOSE_AT = BOTANY_TOURNAMENT_CLOSE_AT.replace(
            tzinfo=timezone.utc
        )
